...
<? } else { ?>
	<link type="text/css" rel="stylesheet" media="all" href="/css/seg_<?= $this->segment() ?>.css?rev=20210415-120533" />
	<script type="text/javascript" src="/js/seg_<?= $this->segment() ?>.js?rev=20210415-120533"></script>
<? } ?>
