...
class HTML extends HTMLCore {
	...
	*/
	function inputRobot($_options = false) {
		...
		$name = "it_nato_bor";
		$name_2 = "it_nato_bor[1]";
		$name_3 = "it_nato_bor[2]";

		// label
		$label = $this->getProperty($name, "label");
		$label_2 = $this->getProperty($name_2, "label_2");
		$label_3 = $this->getProperty($name_3, "label_3");
		...
		$value_2 = $this->getProperty($name_2, "value_2");
		$value_3 = $this->getProperty($name_3, "value_3");
		...
		$class_2 = $this->getProperty($name_2, "class");
		$class_3 = $this->getProperty($name_3, "class");
		$id = $this->getProperty($name, "id");
		$id_2 = $this->getProperty($name_2, "id");
		$id_3 = $this->getProperty($name_3, "id");
		...
		$for_1 = stringOr($id, "input_".preg_replace("/\[\]/", "", $name."_1"));
		$for_2 = stringOr($id, "input_".preg_replace("/\[\]/", "", $name."_2"));
		$for_3 = stringOr($id, "input_".preg_replace("/\[\]/", "", $name."_3"));

		$att_id = $this->attribute("id", $for);

		$att_id_1 = $this->attribute("id", $for_1);
		$att_id_2 = $this->attribute("id", $for_2);
		$att_id_3 = $this->attribute("id", $for_3);

		$att_name = $this->attribute("name", $name);

		$att_name_1 = $this->attribute("name", $name."[0]");
		$att_name_2 = $this->attribute("name", $name."[1]");
		$att_name_3 = $this->attribute("name", $name."[2]");
		...
		$_ .= '<div'.$att_class.'>';
			...
			// $_ .= '<div class="item">';
			// 	$_ .= '<input type="hidden"'.$att_name_2.' value="0" />';
			// 	$_ .= '<input type="checkbox"'.$att_name_2.$att_id_2.$att_value.' />';
			// 	$_ .= '<label'.$this->attribute("for", $for_2).'>'.$label_2.'</label>';
			// $_ .= '</div>';
			//
			// $_ .= '<div class="item">';
			// 	$_ .= '<input type="hidden"'.$att_name_3.' value="0" />';
			// 	$_ .= '<input type="checkbox"'.$att_name_3.$att_id_3.$att_value.' />';
			// 	$_ .= '<label'.$this->attribute("for", $for_3).'>'.$label_3.'</label>';
			// $_ .= '</div>';
